...
## next stage of mild1 progressor
...
ggplot()+
  geom_point(all.df, mapping = aes(x=UMAP_1, y=UMAP_2), color="grey", size=1, stroke=0)+
  geom_point(dev.df, mapping = aes(x=UMAP_1, y=UMAP_2), color="black", size=1, stroke=0)+
  geom_point(next.df[(next.df$severity == "Mild2"),],
             mapping = aes(x=UMAP_1, y=UMAP_2, color=severity), 
             size=1, stroke=0, color = "#00997F")+
  geom_point(next.df[(next.df$severity == "Moderate"),],
             mapping = aes(x=UMAP_1, y=UMAP_2, color=severity), 
             size=1, stroke=0, color = "#1313A9")+
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_Memory_B_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_Memory_B_after_downsampling.png", device = "png")
...
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_Memory_B.txt"), 
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_Naive_B_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_Naive_B_after_downsampling.png", device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_Naive_B.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
