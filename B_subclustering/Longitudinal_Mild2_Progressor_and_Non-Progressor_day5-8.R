...
# non-progressor
mild2.nop <- read.delim("../new_RCA_whole/logitudinal_information_all/Mild2_nonprogression_rising_stage.txt", 
                        sep="\t",header = TRUE)
...
## profile cell count for each sample in progression and non-progression mild2
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1/1.Barplot_of_sample_counts_in_Progression_Mild2_Memory_B_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1/1.Barplot_of_sample_counts_in_NonProgression_Mild2_Memory_B_after_downsampling.png", device = "png")
...
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1//14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_Memory_B.txt"), 
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1//1.Barplot_of_sample_counts_in_Progression_Mild2_Naive_B_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1/1.Barplot_of_sample_counts_in_NonProgression_Mild2_Naive_B_after_downsampling.png", device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1//14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_Naive_B.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
go <- read.delim("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1/GO_of_union_of_upregulated_genes_across_different_cells/CUSTOM139965392115904.human.enrichr.reports.txt",
                  sep = "\t", header = TRUE)
...
pdf("14.sample_counts_subanalysis_for_DEG_analysis_mild2_progression_and_nonprogression_single_cell_timepoint1//heatmap_of_upregulated_genes_in_mild2_progression_and_non_progression_different_timepoints.pdf")
