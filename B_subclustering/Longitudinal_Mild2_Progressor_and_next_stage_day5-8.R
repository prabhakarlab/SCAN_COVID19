...
########################################################################################
###################### enrichment plot between progression baseline and next stage
########################################################################################
...
### plot progression baseline as ref
ref_num <- nrow(dev.df)
...
for (cell.a in  seq_along(unique_celltype)){
  ...
  # barplot for progression baseline 
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild2_progression/1.Barplot_of_sample_counts_in_Progression_Mild2_Naive_B_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild2_progression/1.Barplot_of_sample_counts_in_Progression_Mild2_NEXT_in_Naive_B_after_downsampling.png", device = "png")
...
write.table(de.ij, paste0("14.Next_stage_of_mild2_progression//14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_Naive_B.txt"), 
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild2_progression/1.Barplot_of_sample_counts_in_Progression_Mild2_Memory_B_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild2_progression/1.Barplot_of_sample_counts_in_Progression_Mild2_NEXT_in_Memory_B_after_downsampling.png", device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.Next_stage_of_mild2_progression/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_Memory_B.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
