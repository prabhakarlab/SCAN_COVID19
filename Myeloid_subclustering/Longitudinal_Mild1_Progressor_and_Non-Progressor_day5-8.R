...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_Progression_Mild1_CD14_Mono_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_NonProgression_Mild1_CD14_Mono_after_downsampling.png", device = "png")
...
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage//14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_CD14_Mono.txt"), 
...
go <- read.delim("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/GO_of_upregulated_genes_in_CD14_Mono_mild1_progression_vs_non_progression.txt",
                 sep = "\t", header = TRUE)
go <- go[c(1,2),]
...
pdf(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/heatmap_of_upregulated_genes_in_mild1_progression_and_non_progression_different_timepoints.pdf"))
