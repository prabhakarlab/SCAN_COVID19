...
########################################################################################
###################### enrichment plot between progression and next stage
########################################################################################
...
## profile cell count for each sample in progressor baseline and next stage
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild2_progression/1.Barplot_of_sample_counts_in_Progression_Mild2_CD14_Mono_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild2_progression/1.Barplot_of_sample_counts_in_Non_Progression_Mild2_CD14_Mono_after_downsampling.png", device = "png")
...
write.table(de.ij, paste0("14.Next_stage_of_mild2_progression//14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_CD14_Mono.txt"), 
