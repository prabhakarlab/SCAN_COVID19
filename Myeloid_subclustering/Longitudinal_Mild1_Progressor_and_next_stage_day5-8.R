...
## profile cell count for each sample in progression baseline and next stage
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_CD14_Mono_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_CD14_Mono_after_downsampling.png", device = "png")
...
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_CD14_Mono.txt"), 
