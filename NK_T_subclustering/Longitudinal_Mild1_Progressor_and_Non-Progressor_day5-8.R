...
############
########### enrichment plot between Mild1 progressor and non-progressor day 5-8
###########
...
## profile cell count for each sample in progression and non-progression to see if any sample is overrepresented
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_Progression_Mild1_CD4_Tcm_after_downsampling.png"), device = "png")


all.df.mild2.sub.table <- data.frame(table(all.df.mild2.sub$sampleBatch))
sample.down <- as.character(all.df.mild2.sub.table[(all.df.mild2.sub.table$Freq > 250),"Var1"])
for (i in seq_along(sample.down)){
  sample.down.i <- sample.down[i]
  all.df.mild2.sub.i <- all.df.mild2.sub[(all.df.mild2.sub$sampleBatch == sample.down.i),]
  down.cell.i <- sample(rownames(all.df.mild2.sub.i),250)
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_NonProgression_Mild1_CD4_Tcm_after_downsampling.png"), device = "png")
...
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage//14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_CD4_Tcm.txt"), 
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage//1.Barplot_of_sample_counts_in_Progression_Mild1_CD4_Tem_after_downsampling.png"), device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_CD4_Tem.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_Progression_Mild1_CD16bright_NK_after_downsampling.png"), device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_NonProgression_Mild1_CD16bright_NK_after_downsampling.png"), device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage//14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_CD16bright_NK.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage//1.Barplot_of_sample_counts_in_Progression_Mild1_Cytotoxic_CD8T_after_downsampling.png"), device = "png")




all.df.mild2.sub.table <- data.frame(table(all.df.mild2.sub$sampleBatch))
sample.down <- as.character(all.df.mild2.sub.table[(all.df.mild2.sub.table$Freq > 400),"Var1"])
for (i in seq_along(sample.down)){
  sample.down.i <- sample.down[i]
  all.df.mild2.sub.i <- all.df.mild2.sub[(all.df.mild2.sub$sampleBatch == sample.down.i),]
  down.cell.i <- sample(rownames(all.df.mild2.sub.i), 400)
  all.df.mild2.sub <- rbind(all.df.mild2.sub[(all.df.mild2.sub$sampleBatch != sample.down.i),],
                            all.df.mild2.sub[down.cell.i,])
}
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_NonProgression_Mild1_Cytotoxic_CD8T_after_downsampling.png"), device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_Cytotoxic_CD8_T.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage//1.Barplot_of_sample_counts_in_Progression_Mild1_Naive_CD8T_after_downsampling.png"), device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave(paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/1.Barplot_of_sample_counts_in_NonProgression_Mild1_Naive_CD8T_after_downsampling.png"), device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.sample_counts_subanalysis_for_DEG_analysis_mild1_progression_and_nonprogression_single_cell_rising_stage/14.Single_cell_DEG_between_Mild1_progression_and_nonprogression_in_Naive_CD8_T.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
