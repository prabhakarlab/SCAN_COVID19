...
ggplot()+
  ...
  geom_point(dev.df, mapping = aes(x=UMAP_1, y=UMAP_2), color="black", size=.5, stroke=0)+
  ...
  ggsave("14.Next_stage_of_mild1_progression_rising/UMAP_of_Mild1_progression_and_Next_stage.png",
...
for (cell.a in  seq_along(unique_celltype)){
  ...
  ggplot(freq.n, mapping = aes(x=Var1, y=Freq))+
    ...
    ggsave(paste0("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_",
  ...
  ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
    ...
    ggsave(paste0("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_",
                  "in_",gsub(" ","_",cell),".png"), device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_CD4_Tcm_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_CD4_Tcm_after_downsampling.png", device = "png")
...
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_CD4_Tcm.txt"), 
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_CD4_Tem_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_CD4_Tem_after_downsampling.png", device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_CD4_Tem.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_CD16bright_NK_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_CD16bright_NK_after_downsampling.png", device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_CD16bright_NK.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_Cytotoxic_CD8T_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_Cytotoxic_CD8_T_after_downsampling.png", device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_Cytotoxic_CD8_T.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_Naive_CD8T_after_downsampling.png", device = "png")
...
ggplot(freq.p, mapping = aes(x=Var1, y=Freq))+
  ...
  ggtitle(paste0("number of cell = ",sum(freq.p$Freq),"\n",
                 "number of sample = ", nrow(freq.p)))+
ggsave("14.Next_stage_of_mild1_progression_rising/1.Barplot_of_sample_counts_in_Progression_Mild1_NEXT_Naive_CD8_T_after_downsampling.png", device = "png")
...
de.ij <- de.ij[grep(pattern = "^MT-|^ERCC|^RPS|^RPL|^HSP", 
                    x = de.ij$gene, invert = TRUE),]
write.table(de.ij, paste0("14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_Naive_CD8_T.txt"), 
            sep = "\t", col.names = TRUE,row.names = FALSE, quote = FALSE)
...
for (i in seq_along(cell)){
  ...
  deg.file <- read.table(paste0("./14.Next_stage_of_mild1_progression_rising/14.Single_cell_DEG_between_Mild1_progression_and_NEXT_in_",
                                gsub(" ","_", cell.i),".txt"),
                         sep="\t", header = TRUE)
  ...
  write.table(de.ij.sig[which(de.ij.sig$avg_logFC > 0),"gene"],
              paste0("14.Next_stage_of_mild1_progression_rising/upregulated_genes_in_",
                     gsub(" ","_",cell.i),"_mild1_progression_vs_NEXT.txt"),
              col.names = FALSE, quote = FALSE, row.names = FALSE)
  write.table(de.ij.sig[which(de.ij.sig$avg_logFC < 0),"gene"],
              paste0("14.Next_stage_of_mild1_progression_rising/downregulated_genes_in_",
                     gsub(" ","_",cell.i),"_mild1_progression_vs_NEXT.txt"),
              col.names = FALSE, quote = FALSE, row.names = FALSE)
  ...
  ggplot()+
    ...
    theme(panel.grid.major = element_blank(), 
          ...
          panel.background = element_blank(), 
          axis.line = element_line(colour = "black"))
    ggsave(paste0("14.Next_stage_of_mild1_progression_rising/volcano_plot_in_",
...
ggplot()+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_blank(), 
        axis.line = element_line(colour = "black"))
ggsave(paste0("14.Next_stage_of_mild1_progression_rising/UMAP_of_enrichment_ratio_between_progression_and_NEXT.png")
         ,device = "png",
         width = 7, height = 6)
